...
let WKDetailCollectionViewCellID = "WKDetailCollectionViewCell"
class ProductDetailTopView: UIView {
    ...
    private lazy var collectionView: UICollectionView = {
        let collectionView = UICollectionView(frame: CGRectMake(0, 0, kSCREENW, 375), collectionViewLayout: YMDetailLayout())
        let nib = UINib(nibName: String(WKDetailCollectionViewCell), bundle: nil)
        collectionView.registerNib(nib, forCellWithReuseIdentifier: WKDetailCollectionViewCellID)
    ...
    private lazy var priceLabel: UILabel = {
        ...
        priceLabel.textColor = WKGlobalRedColor()
    ...
    private lazy var describeLabel: UILabel = {
        ...
        describeLabel.textColor = WKColor(0, g: 0, b: 0, a: 0.6)
...
extension ProductDetailTopView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(WKDetailCollectionViewCellID, forIndexPath: indexPath) as! WKDetailCollectionViewCell
...
private class YMDetailLayout: UICollectionViewFlowLayout {
    ...
    private override func prepareLayout() {
        // 设置 layout 布局
        itemSize = CGSizeMake(kSCREENW, 375)
