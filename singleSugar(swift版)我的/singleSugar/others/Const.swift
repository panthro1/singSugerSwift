...
enum WKOtherLoginButtonType: Int {
    /// 微博
    case weiboLogin = 100
    /// 微信
...
/// RGBA的颜色设置
func WKColor(r:CGFloat, g:CGFloat, b:CGFloat, a:CGFloat) -> UIColor {
    return UIColor(red: r / 255.0, green: g / 255.0, blue: b / 255.0, alpha: a)
}

/// 背景灰色
func WKGlobalColor() -> UIColor {
    return WKColor(240, g: 240, b: 240, a: 1)
}

/// 红色
func WKGlobalRedColor() -> UIColor {
    return WKColor(245, g: 80, b: 83, a: 1.0)
}
